...
cycleserver_ip=`cd ~/RAPS_PoC_deployment/deploy-cyclecloud ; terraform output public_ip_address | tr -d '"'`
...
echo "Now you can connect with 'cyclecloud connect scheduler -c $clusterName -k $pub_key'"
